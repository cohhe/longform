...
if ( ! function_exists( 'longform_paging_nav' ) ) :
/**
...
function longform_paging_nav() {
	...
	$links = paginate_links( array(
		...
		'prev_text' => __( '&larr; Previous', 'longform' ),
		'next_text' => __( 'Next &rarr;', 'longform' ),
	) );
...
function longform_posted_on( $post_id = '' ) {
	...
	printf( '<span class="byline"><span class="author vcard">BY <a class="url fn n" href="%4$s" rel="author">%5$s</a></span></span>',
